...
- [ ] When a card is shown, the Review Hero row can be opened too — the review run stats sit inside it, so opening it is what puts those readings in view without a click
- [ ] Opening that row is off unless asked for, because it changes the shape of the section more than opening the section itself does
